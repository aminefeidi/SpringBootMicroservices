...
public class KeycloakServiceImpl implements KeycloakService {
    ...
    public int createUserWithKeycloak(KeycloakUser keycloakUser) {
        ...
        LOGGER.info("KeycloakServiceImpl | createUserWithKeycloak | usersResource : " + usersResource.count().toString());
        ...
        LOGGER.info("KeycloakServiceImpl | createUserWithKeycloak | userRole : " + keycloakUser.getRole());
